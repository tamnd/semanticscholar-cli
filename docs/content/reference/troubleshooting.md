...
Most of these come down to network reality or how semanticscholar serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

semanticscholar rate-limits like any public site. s2 already paces
...
Where a surface is gated, s2 reads a cookie or token you supply
...
`s2`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what s2 actually did
